...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-10 w-max items-center justify-center rounded-xl border border-transparent bg-white px-4 py-2 text-sm font-medium text-[#334155] outline-none transition-[color,background-color,border-color,box-shadow]",
  {
    variants: {},
    defaultVariants: {},
  },
...
>) {
  return (
    ...
    >
      {children}
      <ChevronDownIcon
        className="relative top-[1px] ml-1 size-3 text-[#94a3b8] transition duration-300 group-data-[state=open]:rotate-180"
        aria-hidden="true"
      />
    </NavigationMenuPrimitive.Trigger>
  );
