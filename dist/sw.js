 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */fi();const D={apiKey:"AIzaSyAR7TmlpO7mjky9JDgtLzukMFd5f0lyRiI",authDomain:"ali-compras-a45b5.firebaseapp.com",projectId:"ali-compras-a45b5",storageBucket:"ali-compras-a45b5.firebasestorage.app",messagingSenderId:"437941991960",appId:"1:437941991960:web:3c1d6c89cff718e815e16d",measurementId:"G-ZV43RFEWZP"},dt="cliente-delivery-push-v1",ft="cliente-delivery-product-images-v1",ke=500,bi=[{"revision":"c8d0c0fe821b5fa549485cd9a8c38e7a","url":"manifest.webmanifest"},{"revision":"9767d607e509414f044bc0781f44b7aa","url":"index.html"},{"revision":"c8d0485de5f1bb9c7e89ed7a75379c83","url":"icons/pwa-maskable-512.png"},{"revision":"19defb9945a499844f7d5669ebb19e9f","url":"icons/pwa-logo-512.png"},{"revision":"b4d3e8182f8bb572e3c5ee29118b4631","url":"icons/pwa-logo-192.png"},{"revision":"8300c19a0b72bdfb09e8bdc486c80de1","url":"icons/pwa-logo-180.png"},{"revision":"c9e5a820911d3aa0c911600f11302f53","url":"icons/icon.svg"},{"revision":"a9686071e1c7aa41b344c1c215e7f38b","url":"icons/icon-512.svg"},{"revision":"e3022fd8868db76402fefe3dfc537f85","url":"icons/icon-512.png"},{"revision":"a38dfb0bb17179d6abf0fcf363a0201f","url":"icons/icon-192.svg"},{"revision":"0d0f0c056c52fcc58aa88b676cbd8cee","url":"icons/icon-192.png"},{"revision":"721025be42e0691c1c2992580ce6d552","url":"icons/favicon.png"},{"revision":null,"url":"assets/workbox-window.prod.es5-BBnX5xw4.js"},{"revision":null,"url":"assets/nome-entregai-CRazNOq-.svg"},{"revision":null,"url":"assets/LogoFavicon-IAw9vYqZ.png"},{"revision":null,"url":"assets/logo-entregai-DI-5NNs7.svg"},{"revision":null,"url":"assets/index-sDNhxEDx.css"},{"revision":null,"url":"assets/index-CcrGnaSi.js"},{"revision":"721025be42e0691c1c2992580ce6d552","url":"icons/favicon.png"},{"revision":"8300c19a0b72bdfb09e8bdc486c80de1","url":"icons/pwa-logo-180.png"},{"revision":"b4d3e8182f8bb572e3c5ee29118b4631","url":"icons/pwa-logo-192.png"},{"revision":"19defb9945a499844f7d5669ebb19e9f","url":"icons/pwa-logo-512.png"},{"revision":"c8d0485de5f1bb9c7e89ed7a75379c83","url":"icons/pwa-maskable-512.png"},{"revision":"c8d0c0fe821b5fa549485cd9a8c38e7a","url":"manifest.webmanifest"}].map(e=>e.url),wi=["/storage/v1/object/public/product-images/","/storage/v1/render/image/public/product-images/"];self.addEventListener("install",e=>{e.waitUntil(caches.open(dt).then(t=>Promise.all(bi.map(n=>t.add(n).catch(()=>{})))).catch(()=>{}).then(()=>self.skipWaiting()))});self.addEventListener("activate",e=>{e.waitUntil(caches.keys().then(t=>Promise.all(t.filter(n=>n!==dt&&n!==ft).map(n=>caches.delete(n)))).then(()=>self.clients.claim()))});function yi(e){if(e.method!=="GET")return!1;const t=new URL(e.url);return wi.some(n=>t.pathname.startsWith(n))}function Ii(e){return e.type==="opaque"||e.ok}async function Ei(e){const t=await e.keys();if(t.length<=ke)return;const n=t.length-ke;await Promise.all(t.slice(0,n).map(r=>e.delete(r)))}async function _i(e,t){const n=await caches.open(ft),r=await n.match(e);if(r)return r;const i=await fetch(e);return Ii(i)&&t(n.put(e,i.clone()).then(()=>Ei(n)).catch(()=>{})),i}self.addEventListener("fetch",e=>{if(yi(e.request)){e.respondWith(_i(e.request,t=>e.waitUntil(t)));return}e.request.method!=="GET"||new URL(e.request.url).origin!==self.location.origin||e.respondWith(fetch(e.request).catch(()=>caches.match(e.request).then(t=>t||caches.match("/index.html"))))});const Si="PushManager"in self&&"Notification"in self&&"PushSubscription"in self&&ServiceWorkerRegistration.prototype.hasOwnProperty("showNotification")&&PushSubscription.prototype.hasOwnProperty("getKey");if(Si&&D.apiKey&&D.projectId&&D.messagingSenderId&&D.appId){const e=gi(He(D));mi(e,t=>{const n=t.data||{};self.registration.showNotification(n.title||"Nova notificação",{body:n.body,image:n.image_url||void 0,icon:"/icons/icon-192.png",data:n})})}function Ai(e){const t=e.route||"/notifications";return t.startsWith("/mercado/")?t:e.loja_id?`/mercado/${e.loja_id}${t}`:t}self.addEventListener("notificationclick",e=>{e.notification.close();const t=new URL(Ai(e.notification.data||{}),self.location.origin).href;e.waitUntil(self.clients.matchAll({type:"window",includeUncontrolled:!0}).then(async n=>{const r=n[0];return r?(await r.navigate(t),r.focus()):self.clients.openWindow(t)}))});
