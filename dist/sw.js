 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */li();const D={apiKey:"AIzaSyAR7TmlpO7mjky9JDgtLzukMFd5f0lyRiI",authDomain:"ali-compras-a45b5.firebaseapp.com",projectId:"ali-compras-a45b5",storageBucket:"ali-compras-a45b5.firebasestorage.app",messagingSenderId:"437941991960",appId:"1:437941991960:web:3c1d6c89cff718e815e16d",measurementId:"G-ZV43RFEWZP"},lt="cliente-delivery-push-v1",gi=[{"revision":"a9632eb6a2de04678a1470879c7196d8","url":"manifest.webmanifest"},{"revision":"c2133523882245781f4d3fcb162a13a0","url":"index.html"},{"revision":"ee11c1a45ea3b39f3e24e6b5eea9e5fa","url":"icons/icon.svg"},{"revision":"5d17851ba76e5cc0d45dc445841e2f4c","url":"icons/icon-512.svg"},{"revision":"f6f481008504885e16b7aa5054684d82","url":"icons/icon-512.png"},{"revision":"41f590b3c2f81b29d7fe458111d59245","url":"icons/icon-192.svg"},{"revision":"f3dc1a844587d418bc47159ad53aa6e1","url":"icons/icon-192.png"},{"revision":null,"url":"assets/workbox-window.prod.es5-BBnX5xw4.js"},{"revision":null,"url":"assets/index-CSYGWLFW.css"},{"revision":null,"url":"assets/index-Bq9uVsJ3.js"},{"revision":"f3dc1a844587d418bc47159ad53aa6e1","url":"icons/icon-192.png"},{"revision":"f6f481008504885e16b7aa5054684d82","url":"icons/icon-512.png"},{"revision":"ee11c1a45ea3b39f3e24e6b5eea9e5fa","url":"icons/icon.svg"},{"revision":"a9632eb6a2de04678a1470879c7196d8","url":"manifest.webmanifest"}].map(e=>e.url);self.addEventListener("install",e=>{e.waitUntil(caches.open(lt).then(t=>t.addAll(gi)).then(()=>self.skipWaiting()))});self.addEventListener("activate",e=>{e.waitUntil(caches.keys().then(t=>Promise.all(t.filter(n=>n!==lt).map(n=>caches.delete(n)))).then(()=>self.clients.claim()))});self.addEventListener("fetch",e=>{e.request.method!=="GET"||new URL(e.request.url).origin!==self.location.origin||e.respondWith(fetch(e.request).catch(()=>caches.match(e.request).then(t=>t||caches.match("/index.html"))))});if(D.apiKey&&D.projectId&&D.messagingSenderId&&D.appId){const e=hi(Fe(D));pi(e,t=>{const n=t.data||{};self.registration.showNotification(n.title||"Nova notificação",{body:n.body,image:n.image_url||void 0,icon:"/icons/icon-192.png",data:n})})}function mi(e){const t=e.route||"/notifications";return t.startsWith("/mercado/")?t:e.loja_id?`/mercado/${e.loja_id}${t}`:t}self.addEventListener("notificationclick",e=>{e.notification.close();const t=new URL(mi(e.notification.data||{}),self.location.origin).href;e.waitUntil(self.clients.matchAll({type:"window",includeUncontrolled:!0}).then(async n=>{const r=n[0];return r?(await r.navigate(t),r.focus()):self.clients.openWindow(t)}))});
